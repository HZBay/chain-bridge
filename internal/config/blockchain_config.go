...
type ChainConfig struct {
	...
	AccountManagerAddress string  `envconfig:"WALLET_MANAGER_ADDRESS"`
...
func (c ChainConfig) ToCPOPConfig() blockchain.CPOPConfig {
	return blockchain.CPOPConfig{
		...
		AccountManagerAddress: common.HexToAddress(c.AccountManagerAddress),
	...
	return BlockchainConfig{
		Chains: map[int64]ChainConfig{
			56: { // BSC Mainnet
				...
				AccountManagerAddress: util.GetEnv("BLOCKCHAIN_CHAINS_56_WALLET_MANAGER_ADDRESS", ""),
			...
			1: { // Ethereum Mainnet
				...
				AccountManagerAddress: util.GetEnv("BLOCKCHAIN_CHAINS_1_WALLET_MANAGER_ADDRESS", ""),
			...
			97: { // BSC Testnet
				...
				AccountManagerAddress: util.GetEnv("BLOCKCHAIN_CHAINS_97_WALLET_MANAGER_ADDRESS", ""),
...
func (bc BlockchainConfig) GetValidatedChains() map[int64]ChainConfig {
	...
	for chainID, chainConfig := range bc.Chains {
		...
		if chainConfig.RPCEndpoint != "" &&
			chainConfig.AccountManagerAddress != "" &&
