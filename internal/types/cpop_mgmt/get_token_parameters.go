...
func (o *GetTokenParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetTokenParams) bindTokenID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
