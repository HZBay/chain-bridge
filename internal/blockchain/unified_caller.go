...
// UnifiedBatchCaller handles both CPOP ERC20 and NFT ERC721 batch operations
type UnifiedBatchCaller struct {
...
// NewUnifiedBatchCaller creates a new unified batch caller for both CPOP and NFT operations
func NewUnifiedBatchCaller(rpcURL string, cpopTokenAddr, nftContractAddr common.Address, auth *bind.TransactOpts, chainID int64) (*UnifiedBatchCaller, error) {
...
func (u *UnifiedBatchCaller) GetEthClient() *ethclient.Client {
	return u.client
}

// GetChainID returns the chain ID
func (u *UnifiedBatchCaller) GetChainID() int64 {
	return u.chainID
}

// IsNFTEnabled returns true if NFT operations are supported
func (u *UnifiedBatchCaller) IsNFTEnabled() bool {
...
func (u *UnifiedBatchCaller) BatchMint(ctx context.Context, recipients []common.Address, amounts []*big.Int) (*BatchResult, error) {
...
func (u *UnifiedBatchCaller) BatchBurn(ctx context.Context, accounts []common.Address, amounts []*big.Int) (*BatchResult, error) {
...
func (u *UnifiedBatchCaller) BatchTransfer(ctx context.Context, recipients []common.Address, amounts []*big.Int) (*BatchResult, error) {
	if len(recipients) != len(amounts) {
		return nil, fmt.Errorf("recipients and amounts length mismatch")
	}
...
func (u *UnifiedBatchCaller) BatchTransferFrom(ctx context.Context, fromAddresses []common.Address, toAddresses []common.Address, amounts []*big.Int) (*BatchResult, error) {
...
func (u *UnifiedBatchCaller) NFTBatchMint(ctx context.Context, recipients []common.Address, tokenIds []*big.Int, metadataURIs []string) (*NFTBatchResult, error) {
	...
	log.Info().
		...
		Int64("chain_id", u.chainID).
		Str("contract_address", u.nftContract.Address().Hex()).
	...
	tx, err := u.nftContract.BatchMint(u.auth, recipients, tokenIds, metadataURIs)
	if err != nil {
...
func (u *UnifiedBatchCaller) NFTBatchBurn(ctx context.Context, tokenIds []*big.Int) (*NFTBatchResult, error) {
	if u.nftContract == nil {
		return nil, fmt.Errorf("NFT contract not available for chain %d", u.chainID)
	}
...
func (u *UnifiedBatchCaller) NFTBatchTransferFrom(ctx context.Context, fromAddresses, toAddresses []common.Address, tokenIds []*big.Int) (*NFTBatchResult, error) {
	if u.nftContract == nil {
		return nil, fmt.Errorf("NFT contract not available for chain %d", u.chainID)
	}
...
func (u *UnifiedBatchCaller) waitForConfirmation(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
...
func (u *UnifiedBatchCaller) calculateCPOPEfficiency(operationCount int, actualGas uint64) float64 {
...
func (u *UnifiedBatchCaller) calculateCPOPGasSaved(operationCount int, actualGas uint64) uint64 {
